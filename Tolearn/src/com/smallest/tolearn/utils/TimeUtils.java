...
/**
 * Created by zhangzhilai on 9/10/14. https://github.com/zhangkang/timetool
 */
public class TimeUtils {
	...
	public static String secondToTime(String releasseDate) {
		if (isBlank(releasseDate)) {
			Log.d(MyConstants.UNEXPECTED_ERROR, "data string is empty");
			return "";
		}
		Date now = new Date();
		...
		String result = "";
		Log.d("testtime", String.valueOf(day));
		if (day > 14) {
			result = data;
	 ...
	 *
	 * @param releaseDate
	 *            format: 2012-04-24T10:00:10+08:00
